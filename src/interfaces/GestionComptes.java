...
public class GestionComptes extends javax.swing.JFrame {
    ...
    public ArrayList<Utilisateur> liste_utilisateur() {
        ArrayList<Utilisateur> liste_utilisateur = new ArrayList<>();
        String requeteSelect = "SELECT * FROM utilisateur order by id";
        ResultSet rs;
        try {
            ...
            while (rs.next()) {
                utilisateur = new Utilisateur(rs.getInt("id"), rs.getString("username"), rs.getString("password"));
    ...
    public void afficherUtilisateur() {
        ArrayList<Utilisateur> liste = liste_utilisateur();
        DefaultTableModel model = (DefaultTableModel) table_utilisateurs.getModel();
        model.setRowCount(0);
        Object[] row = new Object[3];
        for (int i = 0; i < liste.size(); i++) {
            row[0] = liste.get(i).getId();
            row[1] = liste.get(i).getUsername();
            row[2] = liste.get(i).getPassword();
            model.addRow(row);
        }
    ...
    public void fichierVersEcran() {
        ...
        int index = table_utilisateurs.getSelectedRow();
        //Définir les valeurs du tableau comme valeurs des champs de saisie
        txt_username.setText(liste_utilisateur().get(index).getUsername());
        txt_password.setText(liste_utilisateur().get(index).getPassword());
    ...
    public void rechercher(String str) {
        ...
        model = (DefaultTableModel) table_utilisateurs.getModel();
        TableRowSorter<DefaultTableModel> trs = new TableRowSorter<>(model);
        table_utilisateurs.setRowSorter(trs);
    ...
    private void initComponents() {
        ...
        txt_username = new composants.TextField();
        ...
        table_utilisateurs = new composants.TableCustom();
        ...
        txt_username.setBackground(new java.awt.Color(246, 246, 246));
        txt_username.setForeground(new java.awt.Color(0, 0, 0));
        txt_username.setFont(new java.awt.Font("Poppins", 0, 17)); // NOI18N
        txt_username.setLabelText("");
        txt_username.setLineColor(new java.awt.Color(10, 178, 255));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(66, 66, 66)
                        .addComponent(btn_ajouter, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(49, 49, 49)
                        .addComponent(btn_annuler, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btn_annuler, javax.swing.GroupLayout.DEFAULT_SIZE, 44, Short.MAX_VALUE)
        ...
        table_utilisateurs.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        table_utilisateurs.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
        table_utilisateurs.setGridColor(new java.awt.Color(112, 112, 112));
        table_utilisateurs.setSelectionBackground(new java.awt.Color(10, 130, 255));
        table_utilisateurs.setSelectionForeground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setViewportView(table_utilisateurs);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btn_modifier, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btn_supprimer, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btn_retour, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txt_rechercher, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btn_afficher, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btn_supprimerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_supprimerActionPerformed
        ...
        int index = table_utilisateurs.getSelectedRow();
        try {
            if (JOptionPane.showConfirmDialog(null, "attention vous avez supprimer un utilisateur etes-vous sûr?", "Suppimer utilisateur",
                    JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                if (true) {

                    stm.executeUpdate("DELETE from utilisateur where id= '" + liste_utilisateur().get(index).getId() + "'   ");
                    afficherUtilisateur();
                    viderChamps();
                    JOptionPane.showMessageDialog(null, "Utilisateur suppimé");
                    // afficherClient();
                } else {
            ...
            JOptionPane.showMessageDialog(null, "erreur de suppression /n" + e.getMessage());
    ...
    private void btn_ajouterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ajouterActionPerformed
        ...
        String requete_ajout = "INSERT INTO utilisateur (username, password)"
        ...
        try {
            if (txt_username.getText().equals("")
                ...
                if (JOptionPane.showConfirmDialog(null, "Confirmer la modification", "Modification",
                        JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                    stm.executeUpdate("UPDATE utilisateur SET username='" + txt_username.getText() + "',prenom='" + txt_password.getText()
                            + "'where id= '" + liste_utilisateur().get(index).getId() + "'   ");
                    afficherUtilisateur();
                    viderChamps();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionComptes.class
